...
import ArrowsIcon from '@/assets/icons/ArrowsFeature.svg?url';
import BulbIcon from '@/assets/icons/BulbFeature.svg?url';
import PersonIcon from '@/assets/icons/PersonFeature.svg?url';
    ...
    <section className="w-full flex flex-col justify-center items-center p-20 lg:p-40">
      ...
      <div className="flex flex-col lg:flex-row gap-10 items-start">
        {features.map((feature, index) => (
          <article
            key={index}
            className="flex flex-col flex-1 justify-center p-4 "
          >
            <Image
              src={feature.icon}
              alt="feature_icon"
            ...
            <p className="text-wrap text-base font-normal text-slate-600">
              {feature.description}
            </p>
          </article>
        ))}
