...
const LandingPageFeatures = () => {
	return (
		<section className="flex flex-col justify-center items-center my-20 lg:my-40">
			<h2 className="text-7xl font-semibold text-center text-wrap text-[#111111] tracking-tighter mb-20">
			...
			<div className="flex flex-col lg:flex-row gap-10 items-start">
				{features.map((feature, index) => (
					<article key={index} className="flex flex-col flex-1 justify-center p-4 ">
						...
						<p className="text-wrap text-base font-normal text-grey1">{feature.description}</p>
					</article>
				))}
			</div>
		</section>
